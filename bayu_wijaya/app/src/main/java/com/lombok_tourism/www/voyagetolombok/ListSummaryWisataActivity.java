...
public class ListSummaryWisataActivity extends AppCompatActivity {
    ...
    private RecyclerView listWisataView;
    private List<DataListWisata> list;
    private ListSummaryAdapter adapterWisata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // yang ini sama dengan DashboardActivity
        // sebaiknya dikelompokkan sesuai dengan fungsinya masing-masing
        // contoh.. (file asli kamu masih ada di git log)

        // todo 3: pisahkan setup, list, dan load data agar lebih rapi
        setupEnv();
        setupList();
    ...
    private void setupEnv() {
        listWisataView = (RecyclerView) findViewById(R.id.RecyclerWisataView);
        list = new ArrayList<>();
    }

    private void setupList() {
        adapterWisata = new ListSummaryAdapter(list);
